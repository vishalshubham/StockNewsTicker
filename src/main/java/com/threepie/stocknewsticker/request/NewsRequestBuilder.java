...
/**
 * NewsRequestBuilder is a Builder class that constructs a request based on given request parameters.
 * This class is sent to Endpoint objects, which take the NewsRequestBuilder and construct a
 * query-string out of the given NewsRequestBuilder in order to issue the appropriate GET request to
...
public class NewsRequestBuilder{
     ...
     * @return This NewsRequestBuilder object with sources attribute set to the given input
     */
    public NewsRequestBuilder setSources(String sources) {
     ...
     * @return This NewsRequestBuilder object with sources attribute set to the given input
     */
    public NewsRequestBuilder setSources(Collection<String> sources) {
     ...
     * @return This NewsRequestBuilder object with query attribute set to the given input
     */
    public NewsRequestBuilder setQ(String q) {
        try {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setCountry(String country) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setDomains(String domains) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setDomains(Collection<String> domains) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setFrom(Date from) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setFrom(String from) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setTo(Date to) {
        TimeZone tz = TimeZone.getTimeZone("UTC");
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
        df.setTimeZone(tz);
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setTo(String to) {
        if (!validateDate(to)) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setSortBy(String sortBy) {
     ...
     * @return This NewsRequestBuilder object with category attribute set to the given input
     */
    public NewsRequestBuilder setPage(Integer page) {
        this.page = page;
        return this;
    }
