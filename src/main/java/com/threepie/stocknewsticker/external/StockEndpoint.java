 ...
 * REST endpoint.
 */
public abstract class StockEndpoint {
    /**
     ...
     * endpoint.
     */
    public abstract ApiResponse sendRequest(StockRequestBuilder apiRequest,
                                            Client restClient);
     ...
     */
    abstract WebTarget buildTarget(StockRequestBuilder apiRequest, Client restClient);
